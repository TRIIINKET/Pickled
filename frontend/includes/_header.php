<?php
// _header.php - shared HTML head. Set $pageTitle and $activePage before including.
...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(pickled_asset_url('css/style.css?v=20260430d')) ?>"/>
