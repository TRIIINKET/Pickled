...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(pickled_asset_url('css/style.css?v=20260617b')) ?>"/>
  <link rel="stylesheet" href="<?= htmlspecialchars(pickled_asset_url('css/global-loader.css?v=20260611a')) ?>"/>
  <link rel="stylesheet" href="<?= htmlspecialchars(pickled_asset_url('css/navbar.css?v=20260615a')) ?>"/>
