...
$pendingTotal = (float) admin_scalar($pdo, "SELECT COALESCE(SUM(total), 0) FROM bookings WHERE LOWER(payment_status) LIKE '%pending%' OR LOWER(payment_status) = 'pay on site'");
