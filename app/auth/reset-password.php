...
require_once $frontendPath . '/includes/config/paths.php';
...
include $frontendPath . '/includes/layouts/header.php';
?>
...
<?php include $frontendPath . '/includes/layouts/footer.php'; ?>
